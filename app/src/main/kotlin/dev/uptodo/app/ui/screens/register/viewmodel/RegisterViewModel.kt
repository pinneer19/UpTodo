package dev.uptodo.app.ui.screens.register.viewmodel
...
import dev.uptodo.app.di.auth.register.RegisterScope
...
class RegisterViewModel @Inject constructor(
    ...
    private fun updateErrorState(errorResId: Int) {
        _uiState.update {
            it.copy(error = errorResId.toUiText())
        }
    }
    ...
    private fun toggleRepeatedPasswordVisibility() {
        _uiState.update {
            it.copy(isRepeatedPasswordVisible = !it.isRepeatedPasswordVisible)
        }
    }
}