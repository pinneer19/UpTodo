    ...
    Column(
        ...
        Box(
            modifier = Modifier
                ...
                .graphicsLayer {
                    this.shape = RoundedPolygonShape(polygon = hexagon, rotation = rotation)
                    this.shadowElevation = 13.dp.toPx()
                    this.clip = true
                    this.ambientShadowColor = Color.Transparent
                    this.spotShadowColor = imageBackgroundColor
                }
        ) {
            Image(
